...
# with open('results_for_different_kappas_exp4.pkl', 'wb') as f:
...
with open('results_for_different_kappas_exp4.pkl', 'rb') as f:
...
print(all_components_results_both[0.02][0.11])
