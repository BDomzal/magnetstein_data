...
components = np.loadtxt(COMPONENTS_RAW_FILE, skiprows=1, usecols=[0,1,2,4,5], #no menton
...
mix = np.loadtxt(MIX_RAW_FILE, skiprows=1, usecols=range(2), 
                  delimiter=',',dtype=float)
...
print(all_components_results_both[0.24000000000000002][0.37])
